...
- When running the source-built Codex CLI from this repository, set `CODEX_HOME=~/.codex-dev` so development runs use an isolated configuration, auth state, and MCP setup.
